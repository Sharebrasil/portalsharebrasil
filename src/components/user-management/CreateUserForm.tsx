...
interface CreateUserFormProps {
  defaultUserType?: "colaborador" | "cliente";
}

export function CreateUserForm({ defaultUserType = "colaborador" }: CreateUserFormProps) {
  const [isLoading, setIsLoading] = useState(false);
  const [userType, setUserType] = useState<"colaborador" | "cliente">(defaultUserType);
