  ...
  const loadEntries = async () => {
    ...
    const formattedEntries = data.map(entry => {
      ...
      return {
        ...
        tvoo: timeValue > 0 ? timeValue.toString() : '',
        tdia: dayTimeValue > 0 ? dayTimeValue.toString() : '',
        tnoit: nightHoursValue > 0 ? nightHoursValue.toString() : '',
        total: totalTimeValue > 0 ? totalTimeValue.toString() : '',
        ifr: ifrTimeValue > 0 ? ifrTimeValue.toString() : '',
